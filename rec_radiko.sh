...
ffmpeg -loglevel quiet -y -i "/tmp/${channel}_${date}" -ab 96k "${outdir}/${PREFIX}_${date}.aac"
ffmpeg -loglevel quiet -y -i "/tmp/${channel}_${date}" -acodec libfdk_aac -ab 96k "${outdir}/${PREFIX}_${date}.aac"
if [ $? = 0 ]; then
